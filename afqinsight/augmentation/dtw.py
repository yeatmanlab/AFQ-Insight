"""Dynamic time warping utilities for pattern-mixing based augmentation methods.

This module is copied entirely from the dtw module accompanying ref [1]_, which
is available at https://github.com/uchidalab/time_series_augmentation and is
licensed under the Apache-2.0 license. The original author of this module is
Brian Iwana.
...
def dtw(
    ...
    """Compute the DTW of two sequences.

    Parameters
    ----------
    prototype : numpy.ndarray
