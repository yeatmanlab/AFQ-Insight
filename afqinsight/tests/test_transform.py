...
def test_remove_group():
    ...
    label_sets_ref = np.load(op.join(
        test_data_path,
        'test_multicol2sets_label_sets.npy'
    ))
    ...
    x_removed_ref = np.load(op.join(
        test_data_path, 'test_remove_group_x.npy'
    ))
...
def test_remove_groups():
    ...
    x_removed_ref = np.load(op.join(
        test_data_path, 'test_remove_groups_x.npy'
    ))
...
def test_select_group():
    ...
    x_select_ref = np.load(op.join(
        test_data_path, 'test_select_group_x.npy'
    ))
...
def test_select_groups():
    ...
    x_select_ref = np.load(op.join(
        test_data_path, 'test_select_groups_x.npy'
    ))
...
def test_shuffle_group():
    ...
    x_shuffle_ref = np.load(op.join(
        test_data_path, 'test_shuffle_group_x.npy'
    ))
